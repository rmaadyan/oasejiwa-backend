...
export class PrismaService implements OnModuleInit, OnModuleDestroy {
  ...
  get emergencyContact() {
    ...
    get tes() {
    return this.client.tes;
  }

  get pertanyaan() {
    return this.client.pertanyaan;
  }

  get likertOption() {
    return this.client.likertOption;
  }

  get diagnosisKategori() {
    return this.client.diagnosisKategori;
  }

  get sectionKategori() {
    return this.client.sectionKategori;
  }
