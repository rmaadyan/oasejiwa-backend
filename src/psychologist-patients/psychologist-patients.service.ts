...
export class PsychologistPatientsService {
  ...
  if (bookings.length > 0) {
    ...
    // Fallback deadline-safe:
    // kalau belum ada Booking, ambil pasien dari SessionNote
...
async getById(currentUser: any, patientId: string) {
  ...
  return {
    ...
    // 🔥 INI YANG BARU (EMERGENCY CONTACT)
